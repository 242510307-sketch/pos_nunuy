        ...
        <div class="card bg-gradient-blue text-white shadow-sm mb-4 rounded-4 border-0">
            <div class="card-body p-4 text-center text-md-start d-flex flex-column flex-md-row align-items-center justify-content-between">
                ...
                <div class="mt-3 mt-md-0">
                    <a href="<?php echo e(route('produk.create')); ?>" class="btn btn-light text-primary fw-bold px-4 py-2 rounded-pill shadow-sm">
                        ✨ Tambah Produk Baru
                    </a>
                </div>
            </div>
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    ...
                                    <td>
                                        <span class="fw-bold text-dark"><?php echo e($product->nama); ?></span>
                                    </td>
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex justify-content-center gap-2">
                                            ...
                                            <a href="<?php echo e(route('produk.edit', $product)); ?>" class="btn btn-sm btn-outline-warning rounded-pill px-3 fw-medium">
                                                ✏️ Edit
                                            </a>
