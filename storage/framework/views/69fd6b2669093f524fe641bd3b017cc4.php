                        ...
                        <form method="POST" action="<?php echo e(route('itempenjualan.store')); ?>" class="row mb-2">
                            ...
                            <div class="col-3">
                                <input type="number" name="quantity" value="1" min="1"
                                    class="form-control <?php echo e($sale->status === 'COMPLETED' ? '' : ''); ?>">
                            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\pos_nunuy\resources\views/penjualan/pos.blade.php ENDPATH**/ ?>